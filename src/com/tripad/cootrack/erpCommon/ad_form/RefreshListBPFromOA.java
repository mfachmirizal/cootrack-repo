...
//            Thread.sleep(6003);
        } catch (CustomJsonErrorResponseException | JSONException jre) {
    ...
    private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strOrgId,
        ...
        try {
            ...
            if (vars.getSessionValue("statusRetrieveCustomer").equals("SedangDlmRetrieveData")) {
                ...
                myMessage.setMessage("Previous Process is running in background, please wait until finish !");
    ...
    //method execute
    private JSONObject execute(OpenApiUtils utils) throws JSONException,CustomJsonErrorResponseException,Exception,Throwable{
        String hasil = "";
