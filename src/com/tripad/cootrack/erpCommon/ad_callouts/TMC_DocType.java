...
public class TMC_DocType extends SimpleCallout {
  ...
  String strDocumentTarget = info.getStringParameter("inpcDoctypetargetId", null);



    info.addResult("inpcDoctypeId", strDocumentTarget);
