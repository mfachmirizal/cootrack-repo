...
public class OpenApiUtils  {
	...
	public String getToken() {
		String getTokenUrl = COOTRACK_GET_TOKEN_URL+"account="+COOTRACK_USERNAME+"&time="+getUnixTime()+"&signature="+(convertToMd5((convertToMd5(COOTRACK_PASSWORD))+getUnixTime()));
